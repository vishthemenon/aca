...
public class ultimate_macro_b2 extends StarMacro {

  static String rootPath = "\\\\icnas1.cc.ic.ac.uk\\vr616\\Desktop\\ACA\\CW2\\real_shit\\data\\base_ultra2\\";
  ...
  public void execute() {
    ...
    double baseSize = 0.017;
    double radius = 90;
    while(baseSize <= 0.017) {
      execute0(
        iterations,
        nearWallThickness,
        prismLayers,
